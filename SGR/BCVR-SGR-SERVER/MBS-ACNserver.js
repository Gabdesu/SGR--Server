...
const FOLDER_ID = '1lgz5m7pXQsS8u25V4tjIIlMU_ojQYaNY'; 
...
async function getSpreadsheetIdForCurrentMonth() {
    const monthNames = ["BCVR [SGR_ACN_MBS_JAN_2026] BCVR Masbate Branch Store | January 2026 - Accounting",
                        "BCVR [SGR_ACN_MBS_FEB_2026] BCVR Masbate Branch Store | February 2026 - Accounting",
                        "BCVR [SGR_ACN_MBS_MAR_2026] BCVR Masbate Branch Store | March 2026 - Accounting",
                        "BCVR [SGR_ACN_MBS_APR_2026] BCVR Masbate Branch Store | April 2026 - Accounting",
                        "BCVR [SGR_ACN_MBS_MAY_2026] BCVR Masbate Branch Store | May 2026 - Accounting",
                        "BCVR [SGR_ACN_MBS_JUN_2026] BCVR Masbate Branch Store | June 2026 - Accounting",
                        "BCVR [SGR_ACN_MBS_JUL_2026] BCVR Masbate Branch Store | July 2026 - Accounting",
                        "BCVR [SGR_ACN_MBS_AUG_2026] BCVR Masbate Branch Store | August 2026 - Accounting",
                        "BCVR [SGR_ACN_MBS_SEP_2026] BCVR Masbate Branch Store | September 2026 - Accounting",
                        "BCVR [SGR_ACN_MBS_OCT_2026] BCVR Masbate Branch Store | October 2026 - Accounting",
                        "BCVR [SGR_ACN_MBS_NOV_2026] BCVR Masbate Branch Store | November 2026 - Accounting",
                        "BCVR [SGR_ACN_MBS_DEC_2026] BCVR Masbate Branch Store | December 2026 - Accounting"               
    ];
    const now = new Date();
