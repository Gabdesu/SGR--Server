...
// =============================================================================
// MASBATE QUERIES
// Centralized SQL query repository for Masbate branch controllers.
...
const prdQueries = {
    ...
    'Procurement': `
        ...
        WHERE (Item_Status != 'Served' AND Item_Status != 'Changed Item' AND Item_Status != 'Waived')
    ...
    'Procurement-Special': `
        ...
        FROM TBL_Orders_Lacking_Details
        INNER JOIN TBL_Orders_Lacking ON TBL_Orders_Lacking.OL_ID = TBL_Orders_Lacking_Details.OL_ID
        WHERE (Item_Status = 'Changed Item' AND Item_Status = 'Waived')
          AND OL_BookingDate <= @EndDate
        ORDER BY Item_Description`,
...
SELECT 
    ...
    ''                   AS [Charge Invoice],
    0.00 AS [DM], 0.00 AS [MSDE], 0.00 AS [GM], 0.00 AS [LSAE],
    0.00 AS [OSEF], 0.00 AS [ASME], 0.00 AS [REEV],
...
SELECT 
    ...
    ''                   AS [Bank Details],
    0.00 AS [Discount], 0.00 AS [Return], 0.00 AS [Rebates],
    0.00 AS [Tax], 0.00 AS [Other Charges],
...
module.exports = {
    buildAcnQueries,   // function — no dbName needed (uses hardcoded [BCVR-IBS] / [BCVR-SBS])
