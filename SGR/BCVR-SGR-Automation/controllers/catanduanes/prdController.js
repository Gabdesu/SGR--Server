...
const BRANCH_META = {
    ...
    PHSSN:  { prefix: 'SGR_PRD_PHSSN',  label: 'Pharmacy & Health Supplies Store Naga'},
    PHSSI:  { prefix: 'SGR_PRD_PHSSI',  label: 'Pharmacy & Health Supplies Store Iriga'},
    CBS:  { prefix: 'SGR_PRD_CBS',  label: 'Catanduanes Branch Store'},
