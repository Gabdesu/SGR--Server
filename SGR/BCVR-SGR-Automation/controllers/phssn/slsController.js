...
const { slsQueries } = require('../../Model/PhssnQueries');
...
// --- BRANCH METADATA MAP ---
const BRANCH_META = {
    PHSSN: { prefix: 'SGR_SLS_PHSSN', label: 'Pharmacy & Health Supplies Store Naga' }
};
...
async function getSpreadsheetIdForCurrentMonth(folderId, branchCode) {
    const meta  = BRANCH_META[branchCode] || BRANCH_META['PHSSN'];
    const now = new Date();
